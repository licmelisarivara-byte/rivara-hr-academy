...
import { CERTIFICADO_CURSO_BOT_ATS } from "@/lib/certificado";
...
export default function CertificadoCursoBotAtsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/certificado", {
        ...
        body: JSON.stringify({ nombre, email, tipo: "curso-bot-ats" }),
      });
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-20">
      ...
      <p className="eyebrow mb-4">Creá tu propio Bot de Selección + ATS con IA</p>
      <h1 className="font-display text-3xl text-bone mb-3">
        Pedí tu certificado del curso
      </h1>
      <p className="text-bone/60 mb-10">
        {CERTIFICADO_CURSO_BOT_ATS.titulo} — {CERTIFICADO_CURSO_BOT_ATS.fecha}.
      </p>
